This is a brantch of the ethjsonrpc libary that only includes the required files from dependent packages, so there are no requirments for
compiled packages, allowing this software to run on windows
